...
// -----------------------------------------------------------------------------
// Header files ----------------------------------------------------------------
//#define __DELAY_BACKWARD_COMPATIBLE__  //teste, sem isto apresentava problemas de compilação na função _delay_us
...
#define LCD_CONTROL_RW		PB5		// User configurable
